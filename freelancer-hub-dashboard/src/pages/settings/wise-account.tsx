...
export const WiseAccountSetup: React.FC = () => {
  ...
  const handleSubmit = (values: any) => {
    ...
    saveWiseAccount(
      ...
      {
        onSuccess: () => {
          message.success("Wise account saved successfully");
          setIsEditing(false);
          setIsSaving(false);
          refetchAccount();
        },
        onError: () => {
          message.error("Failed to save Wise account");
          setIsSaving(false);
        },
      }
    );
    ...
    Modal.confirm({
      ...
      onOk: () => {
        deleteWiseAccount(
          ...
          {
            onSuccess: () => {
              message.success("Wise account removed successfully");
              refetchAccount();
              form.resetFields();
            },
            onError: () => {
              message.error("Failed to remove Wise account");
            },
          }
        );
      },
