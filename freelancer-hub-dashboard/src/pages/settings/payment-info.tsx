...
export const PaymentInfoSettings: React.FC = () => {
  ...
  const fetchPaymentInfo = async () => {
    ...
    try {
      ...
      message.error(error.response?.data?.message || "Failed to fetch payment information");
    } finally {
      setIsFetching(false);
    }
  };
  ...
  const handleSubmit = async (values: any) => {
    if (!isOwner) {
      message.error("Only owners can update payment information");
      return;
    }
        ...
        <Spin spinning={isFetching}>
          <Space direction="vertical" size="large" style={{ width: "100%" }}>
            ...
            >
              ...
              >
                <Input placeholder="billing@example.com" size="large" type="email" />
              </Form.Item>
              ...
              >
                <Input placeholder="e.g., 123-45-6789 or GB123456789" size="large" />
              </Form.Item>
